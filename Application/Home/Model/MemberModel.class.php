...
class MemberModel extends Model{
    ...
    public function _after_insert($data,$option){
    	$content="复制以下链接到浏览器，完成账号邮箱验证：http://127.0.0.1/shop/index.php/Home/User/check_email/es/".$data['mail_str'];
    	SendMail($data['email'],'美妆电子商城商城账号验证',$content);
    }
