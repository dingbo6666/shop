                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="/shop/index.php/Admin/Index/index">系统</a>
                                        ...
                                        <li>
                        <a href="/shop/index.php/Admin/Category/lst">栏目列表</a>
                    </li>
                    ...
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <p class="help-block col-sm-4 red">* 必填</p>
												...
												<div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">帮助类型</label>
                            <div class="col-sm-6">
                                <label>
                                    <input checked="checked" name="type" class="checkbox-slider colored-blue" type="checkbox">
