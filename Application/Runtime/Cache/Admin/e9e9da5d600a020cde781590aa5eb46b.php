...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/shop/index.php/Admin/Adpos/add'">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                                ...
                                <td align="center">
                                    <a href="/shop/index.php/Admin/Adpos/edit/id/<?php echo ($vo["id"]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '/shop/index.php/Admin/Adpos/del/id/<?php echo ($vo["id"]); ?>')" class="btn btn-danger btn-sm shiny">
