                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="/shop/index.php/Admin/Index/index">系统</a>
                                        ...
                                        <li>
                        <a href="/shop/index.php/Admin/Adpos/lst">广告位列表</a>
                    </li>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改广告位</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
											<input type="hidden" name="id" value="<?php echo ($adpos["id"]); ?>">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">广告位名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="pname" value="<?php echo ($adpos["pname"]); ?>" placeholder="" name="pname" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
												<div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">广告位宽度</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="width" value="<?php echo ($adpos["width"]); ?>" placeholder="" name="width" required="" type="text">
                            </div>
                        </div>
												<div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">广告位高度</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="height" value="<?php echo ($adpos["height"]); ?>" placeholder="" name="height" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
