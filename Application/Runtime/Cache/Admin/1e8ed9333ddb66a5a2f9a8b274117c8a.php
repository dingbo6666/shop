                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="/shop/index.php/Admin/Index/index">系统</a>
                                        ...
                                        <li>
                        <a href="/shop/index.php/Admin/MemberLevel/lst">等级列表</a>
                    </li>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增等级</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
											<input type="hidden" name="id" value="<?php echo ($memberLevels["id"]); ?>" />
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">等级名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="level_name" required="" value="<?php echo ($memberLevels["level_name"]); ?>" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
												<div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">积分下限</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="points_min" required="" value="<?php echo ($memberLevels["points_min"]); ?>" type="text">
                            </div>
														<p class="help-block col-sm-4 red">* 必填</p>
                        </div>
												<div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">积分上限</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="points_max" required="" value="<?php echo ($memberLevels["points_max"]); ?>" type="text">
                            </div>
														<p class="help-block col-sm-4 red">* 必填</p>
                        </div>
												<div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">折扣率</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="rate" required="" value="<?php echo ($memberLevels["rate"]); ?>" type="text">
                            </div>
														<p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
