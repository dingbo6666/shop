...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/shop/index.php/Admin/MemberLevel/add'">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                                ...
                                <td align="center"><?php echo ($vo["level_name"]); ?></td>
																<td align="center"><?php echo ($vo["points_min"]); ?></td>
																<td align="center"><?php echo ($vo["points_max"]); ?></td>
																<td align="center"><?php echo ($vo["rate"]); ?></td>
                                <td align="center">
                                    <a href="/shop/index.php/Admin/MemberLevel/edit/id/<?php echo ($vo["id"]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '/shop/index.php/Admin/MemberLevel/del/id/<?php echo ($vo["id"]); ?>')" class="btn btn-danger btn-sm shiny">
