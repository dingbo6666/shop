                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
													...
													<div class="col-sm-6">
															<input class="form-control" id="recname" placeholder="" value="<?php echo ($recpos["recname"]); ?>" name="recname" required="" type="text">
													</div>
											...
											<div class="form-group">
													...
													<div class="col-sm-6">
															<label style="margin-right:10px;">
																	<input name="rectype" value="1" <?php if($recpos['rectype'] == 1): ?>checked="checked"<?php endif; ?> type="radio">
																	<span class="text">商品推荐位 </span>
															</label>
															<label>
																	<input name="rectype" value="2" <?php if($recpos['rectype'] == 2): ?>checked="checked"<?php endif; ?> class="inverted" type="radio">
