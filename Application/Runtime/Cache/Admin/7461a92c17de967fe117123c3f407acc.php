            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                <th class="text-center" width="10%">订单ID</th>
                        ...
                        <tbody>
                                ...
                                <td align="center"><?php echo ($vo["order_id"]); ?></td>
																...
																<td align="center"><?php echo ($vo["goods_attr_str"]); ?></a></td>
																<td align="center"><?php echo ($vo["goods_price"]); ?></a></td>
																<td align="center"><?php echo ($vo["goods_num"]); ?></a></td>
