                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="pname" placeholder="" name="pname" required="" type="text">
                            </div>
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="width" placeholder="" name="width" required="" type="text">
                            </div>
                        </div>
												<div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">广告位高度</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="height" placeholder="" name="height" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
