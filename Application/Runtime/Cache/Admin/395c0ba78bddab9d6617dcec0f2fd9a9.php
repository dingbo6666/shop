...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/shop/index.php/Admin/Category/add'">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                                ...
                                <td align="center"><?php echo ($vo["catename"]); ?></td>
																<td align="center">
																	<?php if($vo['type'] == 1): ?>帮助类型
																	<?php else: ?>
																	普通类型<?php endif; ?>
																</td>
                                <td align="center">
                                    <a href="/shop/index.php/Admin/Category/edit/id/<?php echo ($vo["id"]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '/shop/index.php/Admin/Category/del/id/<?php echo ($vo["id"]); ?>')" class="btn btn-danger btn-sm shiny">
