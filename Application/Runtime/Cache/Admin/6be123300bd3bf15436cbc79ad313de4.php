...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/shop/index.php/Admin/Brand/add'">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                                ...
                                <td align="center">
                                    ...
                                    <a href="#" onClick="warning('确实要删除吗', '/shop/index.php/Admin/Brand/del/id/<?php echo ($vo["id"]); ?>')" class="btn btn-danger btn-sm shiny">
