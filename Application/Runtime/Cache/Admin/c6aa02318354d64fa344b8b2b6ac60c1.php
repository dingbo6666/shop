...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/shop/index.php/Admin/Config/add'">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
													<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
															...
															<td align="center">
																	<?php if($vo['type'] == 1): ?>文本框<?php endif; ?>
																	<?php if($vo['type'] == 2): ?>文本域<?php endif; ?>
																	<?php if($vo['type'] == 3): ?>单选框<?php endif; ?>
																	<?php if($vo['type'] == 4): ?>复选框<?php endif; ?>
                                ...
                                <td align="center">
                                    ...
                                    <a href="#" onClick="warning('确实要删除吗', '/shop/index.php/Admin/Config/del/id/<?php echo ($vo["id"]); ?>')" class="btn btn-danger btn-sm shiny">
